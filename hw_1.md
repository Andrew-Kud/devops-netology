...
1. Proxmox (ткрытый гипервизор на базе KVM с встроенной системой управления кластером).

2. Для сложной Windows ориентированной инфраструктуры с требованиями к высокой доступности и автоматизации oVirt (upstream для Red Hat Virtualization) — лучший выбор.

3. Proxmox или XCP-ng.
...
4. Hyper-V Server 2019 или встроенный Hyper-V в Windows Server.
В крайнем случае Proxmox.

5. Proxmox с LXC контейнерами.
